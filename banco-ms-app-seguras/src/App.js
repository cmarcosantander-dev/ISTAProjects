  ...
  class App extends React.Component {
    ...
    handlePersonasClick = () => {
      this.setState({ 
        showLogin: true,
        backgroundImage: 'login-background' // Cambia la imagen de fondo a login-background.png
      });
    }
    ...
    handleAccessGranted = () => {
      this.setState({ 
        showSecurityCheck: false, 
        showAccountStatement: true,
        backgroundImage: 'cuenta' // Cambia la imagen de fondo a account-background
      });
    }
